...
- PHP 8.4+
- Composer
- MySQL/MariaDB (database sudah dikonfigurasi di `.env`)
- Laravel Framework
...
cd cobak-collab-ppl-rshp

# 2. Pastikan berada di branch test
git checkout test-unit-udin
...
# 5. Jalankan test tertentu saja
php artisan test --filter EditProfileTest
